(function (root, factory) {
    ...
    var $document = $(document),
        ...
        _css = '.cp-color-picker{position:absolute;overflow:hidden;padding:6p' +
            'x 6px 0;background-color:#fffaed;color:#bbb;font-family:Arial,Helve' +
            'tica,sans-serif;font-size:12px;font-weight:400;cursor:default;bo' +
            'rder-radius:5px;z-index: 13;}.cp-color-picker>div{position:relative;overflow:' +
            ...
            'd:linear-gradient(to right,#fffaed,rgba(0,0,0,0))}.cp-alpha-cursor{' +
